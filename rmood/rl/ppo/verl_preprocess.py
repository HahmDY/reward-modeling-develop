...
dataset = "alpacafarm"
train_dataset_path = f"{RMOOD_HOME}/datasets/{dataset}/rl/rl_prompts.json"
val_dataset_path = f"{RMOOD_HOME}/datasets/{dataset}/val/val_prompts.json"

train_dataset_target_path = f"{RMOOD_HOME}/datasets/{dataset}/rl/rl_prompts.parquet"
val_dataset_target_path = f"{RMOOD_HOME}/datasets/{dataset}/val/val_prompts.parquet"
