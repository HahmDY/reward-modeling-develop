...
train_files=$PENALTY_HOME/datasets/alpacafarm/rl/rl_prompts.parquet
test_files=$PENALTY_HOME/datasets/alpacafarm/val/val_prompts.parquet

policy_model_path=Hahmdong/PRM-llama3.2-3b-alpacafarm-sft
reward_model_path=Hahmdong/PRM-llama3.2-3b-alpacafarm-rm

experiment_name=PRM-llama3.2-3b-alpacafarm-rm-ppo
...
python3 -m verl.trainer.main_ppo --config-path=./config --config-name='ppo_megatron_trainer'\
    ...
    trainer.project_name='PenaltyRM' \
